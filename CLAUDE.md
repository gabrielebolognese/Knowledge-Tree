...
"knowledge tree": a browser app (Vite + vanilla TS, no framework) for a history timeline on an
endless pan/zoom canvas. Node >= 20, ESM, strict tsconfig, vitest for tests. See README.md.
